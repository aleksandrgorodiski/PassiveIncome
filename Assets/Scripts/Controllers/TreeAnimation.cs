...
public class TreeAnimation : MonoBehaviour
{
    ...
    {
        if (isCuttedTree) transform.localEulerAngles = new Vector3(transform.localEulerAngles.x, Random.Range(0f, 360f), transform.localEulerAngles.z);
